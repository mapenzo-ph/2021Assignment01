...
# get first dataset
ucx_df = pd.read_csv('clean/gpu_core_ucx.csv')
...
# get second dataset
intel_df = pd.read_csv('clean/gpu_core_intel.csv')
...
# get third dataset
tcp_df = pd.read_csv('clean/gpu_core_tcp.csv')
...
# get fourth dataset
vader_df = pd.read_csv('clean/gpu_core_vader.csv')
...
f.tight_layout()
# plt.show()
plt.savefig('results/plots_by_level/plot_gpu_core.png')
