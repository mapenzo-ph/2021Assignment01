...
# get first dataset
ucx_df = pd.read_csv('clean/gpu_node_ucx.csv')
...
# get second dataset
intel_df = pd.read_csv('clean/gpu_node_intel.csv')
...
# get third dataset
tcp_df = pd.read_csv('clean/gpu_node_tcp.csv')
...
f.tight_layout()
# plt.show()
plt.savefig('results/plots_by_level/plot_gpu_node.png')
