...
# get data
df = pd.read_csv('clean/gpu_core_ucx.csv')
...
df = pd.read_csv('clean/gpu_socket_ucx.csv')
...
df = pd.read_csv('clean/gpu_node_ucx.csv')
...
f.tight_layout()
# plt.show()
plt.savefig('results/plots_by_framework/plot_gpu_ucx.png')
