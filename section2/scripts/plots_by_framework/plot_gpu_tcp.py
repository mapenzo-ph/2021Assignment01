...
# get data
df = pd.read_csv('clean/gpu_core_tcp.csv')
...
df = pd.read_csv('clean/gpu_socket_tcp.csv')
...
df = pd.read_csv('clean/gpu_node_tcp.csv')
...
f.tight_layout()
# plt.show()
plt.savefig('results/plots_by_framework/plot_gpu_tcp.png')
